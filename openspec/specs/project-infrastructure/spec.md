...
A suíte de testes SHALL rodar com settings próprias que isolam o banco de dados de teste (banco distinto, efêmero) e usam hashers de senha rápidos, sem alterar o ambiente de desenvolvimento.
