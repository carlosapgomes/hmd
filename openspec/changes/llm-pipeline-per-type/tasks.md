...
- [ ] 4.1 Slice 004 — `llm1_service` com guardas (strict/language/retry único/fail-closed) + reconciliação + retenção por divergência + transição `bypass_pipeline_divergence` + extensão do gate_release do intake. Ver `slices/slice-004-llm1-reconciliation.md`
