...
- **R5** `anesthetic_support=True` exatamente para: angioplastias arterial periférica e venosa central, filtro cava, permicath, drenagem biliar, nefrostomia, cateterismo cardíaco, angioplastia coronariana, procedimentos neurointervencionais (`art_cerebral`) — conforme lista geral da fonte; os demais `False`.
