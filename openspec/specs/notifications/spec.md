...
Notificações in-app por marcos do ciclo do caso (resposta final, pronto para agendamento, reabertura por intercorrência, encerramento administrativo), com badge de não lidas, lista com janela de visibilidade e redirecionamento contextual ao abrir — sem PHI no conteúdo.
