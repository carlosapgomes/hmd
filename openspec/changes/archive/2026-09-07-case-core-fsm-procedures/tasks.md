...
- [x] 0.1 Confirmar working tree limpa, registrar `BASE_REF`; baseline verde uma vez (gate do change 02 serve) — executado no início: árvore limpa, BASE_REF `dd16f05`, baseline do change 02 (146 testes) válida
