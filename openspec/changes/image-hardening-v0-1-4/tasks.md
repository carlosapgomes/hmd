...
- [ ] Parent: build da imagem + smoke não-root (design D3) — boot gunicorn uid 10001, `/healthz` 200, `manage.py check` prod no container
- [ ] `openspec validate image-hardening-v0-1-4 --strict`
