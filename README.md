...
**v0.1.9 — piloto fase 2 (intake ativo; anonimização determinística-first)**: autenticação por AD
...
1188 testes · 15 specs (`openspec/`) · 20 changes arquivados. Veja `CHANGELOG.md`.
